  ...
  return (
    <div className="space-y-6">
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-dnd-ink/70 line-clamp-2 italic font-serif whitespace-pre-wrap">{item.Text?.replace(/\\n/g, '\n')}</p>
              </div>
      ...
      {filteredItems.length === 100 && (
        <div className="text-center py-12 px-6 border-2 border-dashed border-dnd-gold/20 rounded-2xl bg-dnd-gold/5 mb-8">
          <p className="text-sm font-serif italic text-dnd-ink/60 mb-2">
            Showing the first 100 items.
          </p>
          <p className="text-xs font-sans font-bold text-dnd-gold uppercase tracking-widest leading-relaxed">
            Refine your search using Category, Rarity, or keywords to find more items.
          </p>
        </div>
      )}
